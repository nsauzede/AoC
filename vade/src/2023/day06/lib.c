...
TEST(v4d3, part1_inp01) {
    uint64_t result = compute(INP01);
    ASSERT_EQU(RES01, result);
}
TEST(v4d3, part1_inp1) {
    uint64_t result = compute(INP1);
    ASSERT_EQU(RES1, result);
}
TEST(v4d3, part2_inp02) {
    uint64_t result = compute(INP02);
    ASSERT_EQU(RES02, result);
}
TEST(v4d3, part2_inp2) {
    uint64_t result = compute(INP2);
    ASSERT_EQU(RES2, result);
}
